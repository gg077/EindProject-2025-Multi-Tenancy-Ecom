        ...
        <div class="md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    ...
                    <p class="mt-1 pb-4 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <div class="relative">
                                    ...
                                    >
                                        {{-- Toon het gekozen icoon of standaardtekst --}}
                                    @if($selectedIcon)
                            ...
                            {{-- Veld: Permissies selecteren --}}
                            <div class="col-span-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    {{ __('Role Permissions') }}
                                </label>

                                {{-- Tabel met modules en rechten per module --}}
                                                    ...
                                                    <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                                        @foreach($module['permissions'] as $permission)
                                                            ...
                                                            <label class="inline-flex items-center mr-3">
                                                                ...
                                                                >
                                                                {{-- explode php functie, zet tekst in array, & name / 0 pakt alleen de eerste stuk bv view--}}
                                                                <span class="ml-2">{{ explode(' ', $permission['name'])[0] }}</span>
                                                            </label>
                                                        @endforeach
                                                    </td>
                                                </tr>
