<div class="p-6 bg-white dark:bg-gray-800 rounded shadow space-y-6">
    ...
    <h1 class="text-2xl font-bold text-black dark:text-white mb-6">Nieuw product toevoegen</h1>
...
{{--                        Toont de geselecteerde afbeelding--}}
            ...
            <div>
                <label class="block mb-1 text-black dark:text-white">Nieuwe afbeeldingen toevoegen 
                    <span class="text-sm text-gray-500 dark:text-gray-400">(Max 2MB per afbeelding)</span>
                </label>
                <label class="cursor-pointer border border-dashed border-gray-400 dark:border-gray-600 p-4 rounded flex items-center justify-center hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white">
                    Klik hier om afbeeldingen te kiezen 
                    <input type="file" wire:model="newImages" multiple class="hidden" accept="image/jpeg, image/png, image/jpg">
                </label>
